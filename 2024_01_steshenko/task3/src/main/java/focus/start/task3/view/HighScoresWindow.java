...
public class HighScoresWindow extends JDialog {
    ...
    public void setNoviceHighScore(String winnerName, int timeValue) {
        noviceRecordLabel.setText(createRecordText(winnerName, timeValue));
    }

    public void setMediumHighScore(String winnerName, int timeValue) {
        mediumRecordLabel.setText(createRecordText(winnerName, timeValue));
    }

    public void setExpertHighScore(String winnerName, int timeValue) {
