...
import focus.start.task3.controller.listener.ShowLoseWindowListener;
...
public class LoseWindow extends JDialog implements ShowLoseWindowListener {
    ...
    public LoseWindow(JFrame owner) {
        ...
        setExitListener(e -> owner.dispose());
    }
    ...
    private void setExitListener(ActionListener exitListener) {
